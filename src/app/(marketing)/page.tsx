...
const T = {
  de: {
    nav: { features: 'Features', pricing: 'Preise', faq: 'FAQ', blog: 'Blog', signin: 'Anmelden', cta: '14 Tage testen' },
    badge: 'Von Fotografen gebaut. Fuer Fotografen gemacht.',
    ...
    problem: { label: 'Das Problem', h2: 'Schluss mit fünf verschiedenen Tools.', p1: 'Die meisten Fotobusiness nutzen eine Mischung aus Kalender, Verträgen, E-Mail-Threads und Galerie-Plattformen.', p2: 'Fotonizer bringt alles in einem übersichtlichen System zusammen — speziell für Fotografen entwickelt.' },
    bookings: { label: 'Buchungen', h2: 'Jedes Shooting im Blick.', p1: 'Buchungen, Sessions und Kunden in einer klaren Übersicht verwalten.', p2: 'Immer wissen, was als Nächstes kommt — ohne Tabellen oder verstreute Tools.' },
    contracts: { label: 'Verträge', h2: 'Verträge ohne Aufwand.', p1: 'Verträge in Sekunden erstellen, versenden und verwalten.', p2: 'Kunden unterschreiben online — du behältst alles an einem Ort.' },
    analytics: { label: 'Analysen', h2: 'Dein Studio auf einen Blick.', p1: 'Umsatz, offene Rechnungen, Kunden und Konversionsrate — alles in einer klaren Übersicht.', p2: 'Verstehe, wie dein Business wächst, und triff bessere Entscheidungen.' },
    portal: { label: 'Kundenportal', h2: 'Jeder Kunde bekommt sein eigenes Portal.', p1: 'Jeder Kunde erhält einen privaten Bereich für sein Projekt — Galerie, Vertrag, Timeline und Treffpunkt.', p2: 'Das schafft ein Premium-Erlebnis, das Fotografen und Kunden gleichermaßen begeistert.' },
    featuresSection: { label: 'Alles inklusive', h2: 'Für echte Foto-Workflows gebaut.', sub: 'Von der ersten Buchung bis zur finalen Galerielieferung — Fotonizer unterstützt jeden Schritt.' },
    workflowSection: {
      label: 'Features',
    ...
    features: [
      { icon: '📅', title: 'Buchungen & Sessions', desc: 'Jedes Shooting, jede Session und jeden Kunden in einer klaren Übersicht verfolgen.' },
      { icon: '✍️', title: 'Digitale Verträge', desc: 'Verträge in Sekunden erstellen und versenden. Kunden unterschreiben online.' },
      { icon: '🖼️', title: 'Foto-Galerien', desc: 'Bilder über schicke Online-Galerien übergeben — mit Download-Kontrolle und Kundenauswahl.' },
      { icon: '🔗', title: 'Kundenportal', desc: 'Jeder Kunde erhält einen privaten Bereich für sein Projekt, Verträge, Moodboards und Galerie.' },
      { icon: '📊', title: 'Analysen', desc: 'Umsatz, Konversionsrate und Wachstum auf einen Blick. Verstehe dein Business.' },
    ...
    reviews: [
      ...
      { quote: 'Ich spare mindestens 3 Stunden pro Woche, die ich früher für E-Mails und PDFs gebraucht habe.', name: 'Thomas B.', role: 'Portrait Fotograf · Berlin', stars: 5 },
    ...
    pricing: { label: 'Preise', h2: 'Transparent. Fair. Jederzeit kündbar.', sub: '14 Tage kostenlos testen — keine Zahlung während der Testphase.' },
    faq: { label: 'FAQ', h2: 'Häufige Fragen' },
    finalCta: { h2: 'Führe dein Fotobusiness wie ein Profi.', sub: 'Schließ dich Fotografen an, die ihren Workflow mit Fotonizer vereinfachen.', btn1: '14 Tage kostenlos starten', btn2: 'Demo buchen' },
    trust: ['14 Tage kostenlos', 'DSGVO-konform', 'EU-Server'],
    footer: { tagline: 'Studiomanagement für professionelle Fotografen.', copyright: 'Alle Rechte vorbehalten.', social: '200+ Fotografen vertrauen Fotonizer' },
    footerLinks: [
  ...
  en: {
    nav: { features: 'Features', pricing: 'Pricing', faq: 'FAQ', blog: 'Blog', signin: 'Sign in', cta: 'Try 14 days free' },
    ...
    pricing: { label: 'Pricing', h2: 'Transparent. Fair. Cancel anytime.', sub: 'Start a 14-day free trial — no charge during the trial period.' },
    faq: { label: 'FAQ', h2: 'Common questions' },
    finalCta: { h2: 'Run your photography business like a pro.', sub: 'Join photographers who are simplifying their workflow with Fotonizer.', btn1: 'Start 14-day free trial', btn2: 'Book a demo' },
    trust: ['14 days free', 'GDPR compliant', 'EU servers'],
