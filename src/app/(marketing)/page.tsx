...
const T = {
  de: {
    ...
    pricing: { label: 'Preise', h2: 'Transparent. Fair. Jederzeit kündbar.', sub: 'Kostenlos starten — upgraden wenn du bereit bist.' },
    faq: { label: 'FAQ', h2: 'Häufige Fragen' },
    finalCta: { h2: 'Führe dein Fotobusiness wie ein Profi.', sub: 'Schließ dich Fotografen an, die ihren Workflow mit Fotonizer vereinfachen.', btn1: 'Kostenlos starten', btn2: 'Demo buchen' },
