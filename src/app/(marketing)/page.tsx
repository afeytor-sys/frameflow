...
import { FileText, Images, Clock, Link2, Globe, CreditCard, Check, ChevronDown } from 'lucide-react'
    ...
    <div className="bg-[#F8F7F4] text-[#111110]" style={SA}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#F8F7F4]/90 backdrop-blur-md border-b border-[#E4E1DC]">
        <div className="max-w-[1200px] mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/signup"
              className="text-[13px] font-semibold bg-[#111110] text-[#F8F7F4] px-4 py-1.5 rounded-md hover:bg-[#1E1E1C] transition-colors"
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <h1
            className="text-[#111110] font-semibold leading-[1.05] mb-6"
            style={{ ...CD, fontSize: 'clamp(48px, 8vw, 80px)', letterSpacing: '-0.04em' }}
          >
            Deine Kunden verdienen mehr als einen WeTransfer-Link.
          </h1>

          <p
            className="text-[#7A7670] leading-relaxed mb-10 max-w-[600px] mx-auto"
            style={{ fontSize: '18px' }}
          >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/signup"
              className="w-full sm:w-auto px-6 py-3 bg-[#111110] text-[#F8F7F4] text-[14px] font-semibold rounded-md hover:bg-[#1E1E1C] transition-colors"
              style={{ letterSpacing: '0.01em' }}
            >
              Kostenlos starten
            </Link>
            <a
              href="#features"
              className="w-full sm:w-auto px-6 py-3 border border-[#E4E1DC] text-[#111110] text-[14px] font-semibold rounded-md hover:bg-white transition-colors"
            >
              So funktioniert es ↓
            </a>
          </div>
      ...
      {/* ── HOW IT WORKS ── */}
      <section id="features" className="py-24 px-6 bg-white border-y border-[#E4E1DC]">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
            ...
            <h2
              ...
              style={{ ...CD, fontSize: 'clamp(32px, 4vw, 48px)', letterSpacing: '-0.03em' }}
            >
            ...
            {[
              ...
              <div key={num} className="relative">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="w-10 h-10 rounded-lg bg-[#F2F0EC] flex items-center justify-center flex-shrink-0">
                    <Icon className="w-5 h-5 text-[#111110]" />
                  </div>
                </div>
                <h3
                  className="text-[#111110] font-semibold mb-2"
                  style={{ ...CD, fontSize: '20px', letterSpacing: '-0.02em' }}
                >
                  {title}
                </h3>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div
                key={title}
                className="bg-white rounded-[10px] p-6 border border-[#E4E1DC] hover:shadow-[0_4px_16px_rgba(0,0,0,0.08)] transition-all duration-150"
                style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}
              >
                <div className="w-10 h-10 rounded-lg bg-[#F2F0EC] flex items-center justify-center mb-4">
                  <Icon className="w-5 h-5 text-[#111110]" />
                </div>
                <h3
                  className="text-[#111110] font-semibold mb-2"
      ...
      {/* ── PHOTOGRAPHY TYPES ── */}
      <section className="py-16 px-6 bg-white border-y border-[#E4E1DC]">
        <div className="max-w-[1200px] mx-auto text-center">
          <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#B0ACA6] mb-6">Für jeden Fotografen</p>
          <div className="flex flex-wrap items-center justify-center gap-3">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-2 px-4 py-2 rounded-full border border-[#E4E1DC] bg-[#F8F7F4] text-[14px] font-medium text-[#111110]"
              >
                <span>{emoji}</span>
                <span>{label}</span>
              </div>
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={name}
                className="bg-white rounded-[10px] p-7 border border-[#E4E1DC]"
                style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}
              >
                ...
                <p className="text-[#111110] text-[15px] leading-relaxed mb-5">"{quote}"</p>
                <div>
      ...
      {/* ── PRICING ── */}
      <section id="pricing" className="py-24 px-6 bg-white border-y border-[#E4E1DC]">
        <div className="max-w-[1200px] mx-auto">
          <div className="text-center mb-16">
      ...
      {/* ── CTA BANNER ── */}
      <section className="py-24 px-6 bg-[#111110]">
        <div className="max-w-[700px] mx-auto text-center">
          <h2
            className="text-[#F8F7F4] font-semibold mb-4"
            style={{ ...CD, fontSize: 'clamp(36px, 5vw, 56px)', letterSpacing: '-0.04em' }}
          >
            Bereit für professionelle Kundenportale?
          </h2>
          <p className="text-[#7A7670] text-[16px] mb-8 leading-relaxed">
            Kostenlos starten. Keine Kreditkarte. Upgrade jederzeit möglich.
          </p>
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 px-7 py-3.5 bg-[#C8A882] text-[#111110] text-[14px] font-semibold rounded-md hover:bg-[#B8966E] transition-colors"
            style={{ letterSpacing: '0.01em' }}
          >
      ...
      {/* ── FOOTER ── */}
      <footer className="bg-[#111110] border-t border-white/[0.06] px-6 py-12">
        <div className="max-w-[1200px] mx-auto">
