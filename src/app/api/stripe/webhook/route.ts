      ...
      case 'customer.subscription.deleted': {
        ...
        if (photographer?.email) {
          await resend.emails.send({
            ...
            subject: 'Dein FrameFlow-Abo wurde beendet',
            html: `
<div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;padding:32px;">
  ...
  <p style="color:#6B6B6B;margin:0 0 16px;">
    ...
    dein FrameFlow-Abo wurde beendet. Du wurdest auf den kostenlosen Plan zurückgesetzt.
  </p>
...
<div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;padding:32px;">
  ...
  <p style="color:#6B6B6B;margin:0 0 16px;">
    Hallo ${photographer.full_name || 'Fotograf'},<br><br>
    die Zahlung für dein FrameFlow-Abo ist fehlgeschlagen. 
