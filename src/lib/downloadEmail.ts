...
export async function sendDownloadReadyEmail(
  ...
  const t = locale === 'en' ? {
    ...
    subheading:    'Beautifully edited and carefully selected.',
    body:          'Take your time going through every image.',
    cta:           'Download photos',
    ...
    subheading:    'Mit viel Liebe bearbeitet und sorgfältig ausgewählt.',
    body:          'Nimm dir Zeit und schau sie dir in Ruhe an.',
